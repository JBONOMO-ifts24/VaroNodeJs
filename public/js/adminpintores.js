document.addEventListener("DOMContentLoaded", (event) => {
  ...
  async function mostrarDatos() {
    ...
    res.forEach((dato) => {
      ...
      d.setAttribute("id", `${dato.idpintores}`);
      d.innerHTML = `${dato.nombre_pintor} <button class='btn btn-primary' onclick= 'modifDato(${dato.idpintores})'>✏️</button><button class='btn btn-primary' onclick= 'borrar(${dato.idpintores})'>❌</button>`;
  ...
  function modifDato(id) {
    ...
    const idciu = document.getElementById("id_pintor");
